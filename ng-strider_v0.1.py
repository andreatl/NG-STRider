...
def get_options():
	...
	p.add_option('--probe', '-p', default="codis_hg18.config", help="Probe config file - provides chromosomal location data and repeat sequence.")
...
def main():			
	...
	for file in input_list:
		print file
		samfile, head = check_inputs(file)
		#sex_type(samfile) -- unimplemented
		k = 1
		for STRlocus in probe_list:
			...
			# print progress
			print probe.id+": "+str(k)+"/"+str(len(probe_list))
			k += 1
		samfile.close()
